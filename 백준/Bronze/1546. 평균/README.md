...
<p>문제를 풀때 형변환이 되는 상황을 제대로 인식하지 못하면 프로그래밍 버그가 난다. 문제에서 제시한 대로 숫자 100 을 곱하게 되면 소숫점 아래 자리수들까지 나타내지 못하므로 100.0 을 곱해 주어야 double로 형변환이 된다.</p>